...
export default function StripeConnect(props){
  ...
  //use a useEffect hook to parse the query parameters attached to the URL from the Stripe redirect
  //for parsing we use query-string node module, if url query parameter contains an auth code and not an error, we make an API call in order to complete the Stripe OAuth
