...
export default function Suggestions (props) {
  ...
  //the received list is iterated over,
            //individual prodcuts are rendered with relevant details, a link to the specific product pagem
                //also an AddToCart component
    return (<div>
