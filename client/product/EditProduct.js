...
//contains the same form as NewProduct but with populated values of the prodcuts retrieved using the read product API
export default function EditProduct ({match}) {
  ...
  //use update fetch method from API, to send multipart form data with a PUT request ot the edit product API
  const clickSubmit = () => {
