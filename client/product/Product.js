...
export default function Product({ match }) {
  ...
  //product details, related products list data will be fetched by calling the relevant api's with useEffect hooks using the productId specified in the route param

  //we call the read API to retrieve the specified products and set it to state
  useEffect(() => {
  ...
  //we call the listRelated API to get the list of related products and set it to the state to be passed as a prop to a Suggestions component added in Product view
  useEffect(() => {
    const abortController = new AbortController()
    const signal = abortController.signal
  ...
  //takes product obj and css style obj as props
  //Suggestions componenet is added with the related list data passes as a prop
  return (
