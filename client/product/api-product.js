...
//construct the url with query param and calls a fetch to make a request o the search product api

//we use query-string node module, to help stringify the params obj into a query string that can be attached
  //to the request route url.
    //the keys and values in this params obj will be defined by reat componenet where we call this list
