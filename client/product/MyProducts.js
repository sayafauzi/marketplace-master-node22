...
export default function MyProducts (props){
  ...
  //relevant products are intiallly loaded in a state with an useEffect hook using listByShop fetch method
  useEffect(() => {
  ...
  //this method is provided as the onRemove prop to the DeleteProduct component
