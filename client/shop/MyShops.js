...
export default function MyShops(){
 ...
 //removeShop method updates state with midified list of shops for the curr user 
  const removeShop = (shop) => {
    ...
    if (redirectToSignin) {
     ...
     //DeleteShop component takes shop obj and onRemove func as props
    return (
    <div>
        ...
        {shops.map((shop, i) => {
            return   <span key={i}>
              <ListItem button>
                ...
                //edit button links to Edit Shop view, and DeleteShop component updates list by callin removeShop method passed from myShops
