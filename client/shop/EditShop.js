...
export default function EditShop ({match}) {
  ...
  //very similar to NewShop Component except we utilize the read API to featch the given shop's details in useEffect hook,
  ...
  //here instead of create we are callin the update API
  const clickSubmit = () => {
  ...
  const handleChange = name => event => {
    ...
    //sellers can manage a shop and its contents, provided with shop ID in a prop so the products can be fetched...
