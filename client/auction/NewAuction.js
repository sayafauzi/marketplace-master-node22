...
//the implementation is similar to NewShop componenetm
//differences are the the date-time input options for the auction start and end timings
//we use Material-UI TextField components with type set to datetime-local
...
//JavaScript date obj and formats it -->yyyymm-ddThh:mm
...
export default function NewAuction() {
  ...
  //assign default start time to the current date-time and the defualt end time to an hour after the curr date-time
  ...
  const clickSubmit = () => {
    //ensure user has entered dates correctly, with the start time set to a value before end time,
    //we need to add check before submitting the form details
